...
<head>
    ...
    <title>NIXI Credit Note Generated</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 8px 8px;">
        ...
        <p style="margin: 0 0 20px 0;">This is to inform you that a <strong>Credit Note</strong> has been generated for the following invoice:</p>
        ...
        <p style="margin: 0 0 20px 0;">You may download the credit note PDF from the portal. A new invoice can be generated for the same period if needed.</p>
