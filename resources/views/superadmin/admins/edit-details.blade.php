...
<div class="container-fluid px-2 py-0">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
        <div>
            <h2 class="mb-1 border-0">Edit Admin Details</h2>
        ...
        <div class="col-md-12 col-lg-7">
            <div class="card border-c-blue shadow-sm" style="border-radius: 16px;">
                ...
                <div class="card-body p-4">
                    @if ($errors->any())
                        <div class="alert alert-danger border-0 rounded">
                            <ul class="mb-0">
                    ...
                    <form method="POST" action="{{ route('superadmin.admins.update-details', $admin->id) }}" class="theme-forms">
                        @csrf
