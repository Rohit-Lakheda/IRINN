    ...
    <div class="auth-row">
        ...
        <div class="card before-login w-100">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.login.verify.otp') }}" id="verifyOtpForm">
                    @csrf
                ...
                <form id="resendOtpForm" method="POST" action="{{ route('admin.login.resend-otp') }}" style="display: none;">
                    @csrf
                </form>
            </div>
            <div class="text-center mb-3">
                <a href="{{ route('admin.login') }}" class="text-decoration-none text-blue">Back to Login</a>
            </div>
        </div>
    </div>
